...
contract TestConsumer is ERC1155Holder {
    ...
    function exitsEqual(ExitFormat.SingleAssetExit[] memory exitA, ExitFormat.SingleAssetExit[] memory exitB)
        public
        pure
        returns (bool)
    {
    ...
    function executeSingleAssetExit(ExitFormat.SingleAssetExit memory singleAssetExit) public {
